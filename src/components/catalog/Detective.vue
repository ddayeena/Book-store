<template>
  <div class="catalog">
     <h1>ДЕТЕКТИВИ</h1>
    <p class="start">Найкращі детективні історії від майстрів кримінального жанру:
                    бойовики й інтелектуальні головоломки, «жіночі», іронічні, містичні детективи, 
                    світові й вітчизняні бестселери. Жорстокі вбивства, захопливі розслідування та неочікувані розв’язки!</p>
...
export default {
  ...
  methods: {
    fetchBooks() {
      axios.get('http://localhost/Book-Store/database/getBooksByGenre.php?genre_id=1')
        .then(response => {
