...
export default createRouter({
    ...
    routes:[
        ...
        { path: '/admin', name:'AdminProfile',component:AdminProfile,meta:{layout:'full-page'}},
        { path: '/manage-users', name:'ManageUsers',component:ManageUsers,meta:{layout:'full-page'}}
    ]
})
